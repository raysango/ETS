module PatientsHelper
  ...
  def patient_ets_summary(patient, facility)
    ...
    "This #{patient.patient_age} years old #{patient.gender} was admitted to #{facility.name} emergency facility on #{datetime_formatted(patient.admission.moment)} due to
